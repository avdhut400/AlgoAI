...
//             className="h-[440px] w-full max-w-lg p-4 bg-white dark:bg-zinc-900 rounded-lg border border-gray-200 dark:border-slate-800 flex flex-col"
//           >
//             <div className="flex items-center gap-3">
//               <Sparkles className="w-6 text-[#00DA83]" />
...
//             <button
//               disabled={loading}
//               className="mt-auto w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#00DA83] to-[#009BB3] text-white px-4 py-2 text-sm rounded-lg disabled:opacity-70"
//             >
//               {loading ? (
//                 <span className="w-4 h-4 my-1 rounded-full border-2 border-t-transparent animate-spin"></span>
//               ) : (
...
//           {/* RIGHT BOX */}
//           <div className="h-[440px] w-full max-w-lg p-4 bg-white dark:bg-zinc-900 rounded-lg border border-gray-200 dark:border-slate-800 flex flex-col">
//             <div className="flex items-center gap-3">
//               <FileText className="w-5 h-5 text-[#00DA83]" />
//               <h1 className="text-xl font-semibold">
//                 Analysis Results
...
//                     Upload a resume and click “Review Resume”
//                   </p>
//                 </div>
//               </div>
//             ) : (
//               <div className="mt-3 flex-1 overflow-y-scroll text-sm text-slate-600 dark:text-slate-300">
//                 <div className="reset-tw">
//                   <Markdown>{content}</Markdown>
//                 </div>
//               </div>
