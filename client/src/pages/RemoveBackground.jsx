...
// import { Eraser, Sparkles, Moon, Sun } from "lucide-react";
...
//         <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 mt-5 ml-24">

//           {/* LEFT BOX */}
//           <form
//             onSubmit={onSubmitHandler}
//             className="h-[420px] w-full max-w-lg p-4 bg-white dark:bg-zinc-900 rounded-lg border border-gray-200 dark:border-slate-800 flex flex-col mt-24"
//           >
//             <div className="flex items-center gap-3">
//               <Sparkles className="w-6 text-[#FF4938]" />
...
//             <button
//               disabled={loading}
//               className="mt-auto w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#F6AB41] to-[#FF4938] text-white px-4 py-2 text-sm rounded-lg disabled:opacity-70"
//             >
//               {loading ? (
...
//           {/* RIGHT BOX */}
//           <div className="h-[420px] w-full max-w-lg p-4 bg-white dark:bg-zinc-900 rounded-lg border border-gray-200 dark:border-slate-800 flex flex-col mt-24">
//             <div className="flex items-center gap-3">
//               <Eraser className="w-5 h-5 text-[#FF4938]" />
//               <h1 className="text-xl font-semibold">
//                 Processed Image
